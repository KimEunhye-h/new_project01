		...
		<div class="inner1220">
			...
			<aside class="sAsideMenu">
				...
				<ul class="sAsideMul">
					...
					<li class="active"><a href="javascript:location.href='list.job';"
				...
				<div class="subTitle">
					...
					<table>
						...
						<tr>
							...
							<td colspan="11" class="vall"><c:if
									...
									<a href="download.job?id=${vo.id }"><i
					...
					<div class="btnSet">
						...
						<c:if
							...
							<a class="btn-fill"
								onclick="$('form').attr('action','modify.job');$('form').submit()">수정</a>
							<a class="btn-fill"
								onclick="if(confirm('정말 삭제?')){ $('form').attr('action','delete.job'); $('form').submit() }">삭제</a>
						</c:if>
					</div>
					...
					<form action="list.job" method="post">
