				...
				<div class="subTitle">
					...
					<div class="btnSet">
						...
						<c:if
							...
							<a class="btn-fill"
								onclick="$('form').attr('action','modify.sc');$('form').submit()">수정</a>
							<a class="btn-fill"
								onclick="if(confirm('정말 삭제?')){ $('form').attr('action','delete.sc'); $('form').submit() }">삭제</a>
						</c:if>
					</div>
					...
					<form action="list.sc" method="post">
						<input type="hidden" name="id" value="${vo.id}"> <input
							...
							type="hidden" name="pageList" value="${page.pageList}">
					</form>
					<div id="popup"></div>
