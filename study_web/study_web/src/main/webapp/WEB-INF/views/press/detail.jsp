		...
		<div class="inner1220">
			...
			<section class="sSubConSection">
				...
				<div class="subTitle">
					...
					<div class="btnSet">
						<a class="btn-fill"
							href='list.pr?curPage=${page.curPage}&search=${page.search}&keyword=${page.keyword}'>목록으로</a>
						<c:if test="${login_info.admin eq 'y' }">
							<a class="btn-fill" href='modify.pr?id=${vo.id}'>수정</a>
							<a class="btn-fill"
								onclick="if(confirm('정말삭제??')) {href='delete.pr?id=${vo.id}'} ">삭제</a>
						</c:if>
						<!-- share -->
