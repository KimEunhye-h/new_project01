	...
	<div class="subContainer" id="contents">
		<div class="inner1220">
			...
			<section class="sSubConSection">
				...
				<div class="subTitle">
					<h2>의견 및 질문</h2>
					<form action="update.op" method="post"
						...
						<table>
							<tr>
								...
								<td><input class="need need_title" placeholder="제목을 입력해주세요." type="text" name="title"
									value="${vo.title }" /></td>
							</tr>
							<tr>
								<th>내용</th>
								<td><textarea class="need need_content" style="height: 341px" placeholder="내용을 입력해주세요." name="content">${vo.content }</textarea></td>
							</tr>
							<tr>
								<th>첨부파일</th>
								<td class="left"><label><input id='attach-file'
										type="file" name="file"> <img src="img/select.png"
										class="file-img" /> </label> <span id='file-name'>
										${vo.filename}</span> <span id='delete-file'
									style='display: ${empty vo.filename ? "none" : "inline"}; color:red;'><i
