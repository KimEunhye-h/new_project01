		...
		<div class="inner1220">
			...
			<aside class="sAsideMenu">
				...
				<ul class="sAsideMul">
					...
					<li class="active"><a
						href="javascript:location.href='list.un';"
			...
			<section class="sSubConSection">
				...
				<div class="subTitle">
					...
					<table>
						...
						<tr>
							<th>첨부파일</th>
							<td colspan="11" class="vall"><c:if test="${!empty vo.filename}">${vo.filename }
								<span id="preview"></span>
									<a href="download.un?id=${vo.id }"><i
					...
					<div class="btnSet">
						...
						<c:if
							...
							<a class="btn-fill"
								onclick="$('form').attr('action','modify.un');$('form').submit()">수정</a>
							<a class="btn-fill"
								onclick="if(confirm('정말 삭제?')){ $('form').attr('action','delete.un'); $('form').submit() }">삭제</a>
						</c:if>
					</div>
					...
					<form action="list.un" method="post">
