		...
		<div class="inner1220">
			...
			<aside class="sAsideMenu">
				...
				<ul class="sAsideMul">
					...
					<li class="active"><a href="javascript:location.href='list.un';"
			...
			<section class="sSubConSection">
				...
				<div class="subTitle">
					<h2>대학/편입</h2>
					<form action="update.un" method="post"
						...
						<table>
							...
							<tr>
								<th colspan="1">내용</th>
								<td colspan="3"><textarea style="height: 341px" placeholder="내용을 입력해주세요." name="content" class="need need_content" title="내용">${vo.content}</textarea></td>
							</tr>
							<tr>
