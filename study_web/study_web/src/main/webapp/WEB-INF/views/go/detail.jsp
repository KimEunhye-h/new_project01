				...
				<div class="subTitle">
					...
					<div class="btnSet">
						...
						<c:if
							...
							<a class="btn-fill"
								onclick="$('form').attr('action','modify.go');$('form').submit()">수정</a>
							<a class="btn-fill"
								onclick="if(confirm('정말 삭제?')){ $('form').attr('action','delete.go'); $('form').submit() }">삭제</a>
						</c:if>
					</div>
