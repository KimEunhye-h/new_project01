	...
	<div class="subContainer" id="contents">
		<div class="inner1220">
			...
			<section class="sSubConSection">
				...
				<div class="subTitle">
					<h2>받은 쪽지함</h2>
					<form id="list" action="list.me" method="post">
							...
							<div>
								<ul style="margin-bottom: 8px;">
									...
									<c:if test="${!empty login_info}">
										<!-- 로그인되어 있으면 글쓰기 가능 -->
										<li><a class="btn-fill" href="list.me" style="background-color: #000; color: #fff">받은 쪽지함</a></li>
    									<li><a class="btn-fill" href="list2.me" >보낸쪽지함</a></li>
					...
					<div id="data-list">
						<table>
							<tr>
								<th class="w-px100">보낸사람</th>
								<th>내용</th>
								<th class="w-px120">발송날짜</th>
							</tr>
							<c:forEach items="${page.list}" var="vo">
								<tr>
									<td class="w-px60">${vo.sender}</td>
...
function go_detail(mid){
	 $('[name=mid]').val(mid);
	   $('form').attr('action');   
	   $('form').submit();
	   window.open('detail.me?mid='+mid,'message','width=400,height=450,status=no,scrollbars=auto');
}
