...
<div id='detail-pop'>
			<section class="sSubConSection">
				...
				<div class="subTitle" style="width: 100%;">
					<h2 style="text-align: center;">받은 쪽지 상세</h2>
					<table style="    display: block; width: 390px; border: 1px; margin: 5px;">
						<tr>
							<th style="width: 85px;">보낸 사람</th>
							<td style="width: 119px;" class="w-px100" colspan="3">${vo.sender}</td>
							<th style="width: 90px;" class="w-px100">작성일자</th>
							<td style="width: 90px;">${vo.senddate}</td>
						</tr>
						<tr>
					...
					<div class="btnSet" style="text-align: center; margin-top: 10px;">
						<a class="btn-fill" onclick="$('#detail-pop').css('display', 'none'); $('#new-pop').css('display', 'block')">답장하기</a>
