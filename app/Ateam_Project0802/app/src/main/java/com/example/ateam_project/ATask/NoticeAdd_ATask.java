...
public class NoticeAdd_ATask extends AsyncTask<Void,Void,String> {
    String name,title,content,today;
    String state = "";

    public NoticeAdd_ATask(String title, String name, String content, String today) {
        this.name = name;
        this.title = title;
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = subJectIpConfig + "/app/NoticeAdd";
            // 전송
            ...
            Log.d("main:anInsertMulti", e.getMessage());
            e.printStackTrace();
        }finally {
            if(httpEntity != null){
                httpEntity = null;
