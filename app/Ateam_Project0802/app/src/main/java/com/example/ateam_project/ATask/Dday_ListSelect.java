...
public class Dday_ListSelect extends AsyncTask<Void,Void,Void> {
    //생성자
    ArrayList<Dday_ItemDTO> itemlist;
    Dday_ItemAdapter adapter;
    String name;

    public Dday_ListSelect(ArrayList<Dday_ItemDTO> itemlist, Dday_ItemAdapter adapter,String name){
    ...
    public Dday_ItemDTO readMessage(JsonReader reader) throws IOException {
        ...
        reader.endObject();
        Log.d("listselect:myitem",name+","+ title + "," + pickerdate + "," + d_day );
