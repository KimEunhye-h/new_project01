...
public class StudyTimeSelectSubDay extends AsyncTask<Void, Void, String> {
    private static final String TAG = "main";
    String name, today;

    public StudyTimeSelectSubDay(String name, String today) {
        this.name=name;
        this.today=today;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = subJectIpConfig + "/app/studyCalSelectMulti2";
    ...
    public String readMessage(InputStream inputStream) throws IOException {
        ...
        reader.endObject();
        Log.d("main:ChangeNameSelect", name);
        return total;
    }
