...
public class StudyCalSelectMonthBest extends AsyncTask<Void, Void, String> {
    private static final String TAG = "main";
    String name, today;

    public StudyCalSelectMonthBest(String name, String today) {
        this.name=name;
        this.today=today;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = subJectIpConfig + "/app/studyCalSelectMonthBest";
