...
public class SignUpInsert_ATask extends AsyncTask<Void, Void, String> {

    String email,name,pw,job;

    public SignUpInsert_ATask(String email, String name, String pw, String job) {
        this.email = email;
        this.name = name;
        this.pw = pw;
        this.job = job;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = subJectIpConfig + "/app/anJoin111";
            // 전송
