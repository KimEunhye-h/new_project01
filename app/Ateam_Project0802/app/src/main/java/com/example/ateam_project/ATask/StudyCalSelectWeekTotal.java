...
public class StudyCalSelectWeekTotal extends AsyncTask<Void, Void, String> {
    private static final String TAG = "WeekTotal";
    String name, today;

    public StudyCalSelectWeekTotal(String name, String today) {
        this.name=name;
        this.today=today;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = subJectIpConfig + "/app/studyCalSelectWeekTotal";
