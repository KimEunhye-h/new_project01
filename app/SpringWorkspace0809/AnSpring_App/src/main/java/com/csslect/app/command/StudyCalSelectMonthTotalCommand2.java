...
//한달 과목별 총시간조회
public class StudyCalSelectMonthTotalCommand2 implements ACommand {
	@Override
	public void execute(Model model) {			
		...
		ArrayList<MonthTotalDTO> totalList = dao.studyCalSelectMonthTotal2(name, today);	
		
		System.out.println("total time : " + totalList.size());
				
		model.addAttribute("studyCalSelectMonthTotal2", totalList); 
