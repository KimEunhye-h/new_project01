...
//일주간 총시간조회
public class StudyCalSelectWeekTotalCommand implements ACommand {
	@Override
	public void execute(Model model) {			
		...
		String total = dao.studyCalSelectWeekTotal(name, today);	
		
		System.out.println("total time : " + total);
				
		model.addAttribute("studyCalSelectWeekTotal", total); 
